...
<div id="top">
	...
	<div id="left">
		<div class="polling_wrap">
			...
			<div class="barra_sx"><a href="info.php">Info</a></div>
	...
	<div id="center">
		...
		<div id="scrivi">
			<form action="javascript:pubblica()">
				<input type="text" class="material_input" id="testo" placeholder="Condividi Qualcosa">
				<input type="submit" value="Invia" class="bottone">
			</form>
		</div>

		<a id="load_more" href="javascript:loadMore(0)">Carica Altri</a>
	</div>
